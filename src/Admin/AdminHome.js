    ...
    return (
      ...
      <View style={{flexDirection:'column', flex:1, marginLeft:10, marginBottom:10, marginRight:10}}>
          <View style={{flexDirection:'row', flex:1}}>
            <View style={{flex:1}}>
              <TouchableOpacity style={styles.buttonView} onPress={this.addUsers}>
                <Image style={styles.imageIcon} source={{uri: 'https://cdn1.iconfinder.com/data/icons/ios-11-glyphs/30/add_user_male-256.png'}}/>
              </TouchableOpacity>
            </View>
            ...
            <View style={{flex:1}}>
              <TouchableOpacity style={styles.buttonView} onPress={this.teacherHandle}>
            <Image style={styles.imageIcon} source={{uri: 'https://cdn0.iconfinder.com/data/icons/education-340/100/Tilda_Icons_1ed_teacher-512.png'}}/>
              </TouchableOpacity>
            </View>
          ...
          <View style={{flexDirection:'row', flex:1}}>
            ...
            <View style={{flex:1}}>
              <TouchableOpacity style={styles.buttonView}>
                <Image style={styles.imageIcon} source={{uri: 'http://icons.iconarchive.com/icons/custom-icon-design/silky-line-user/96/user-man-remove-icon.png'}}/>
              </TouchableOpacity>
            </View>
